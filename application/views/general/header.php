...
<body class="h-100" id="page-top">
    ...
    <div class="row">
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top navbar-shrink" id="mainNav">
            <!-- <div class="container"> -->
            <a class="navbar-brand ms-5" href="#page-top">Manufaktur</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="<?php echo base_url('index.php/main'); ?>">Home</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="<?php echo base_url('index.php/main/maps'); ?>">Maps</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="<?php echo base_url('index.php/main/about'); ?>">About</a></li>
                </ul>
            </div>
            <!-- </div> -->
        </nav>
